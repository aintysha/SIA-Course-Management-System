...
const gradeValidationSchema = joi_1.default.object({
    // Grade ID validation
    // - Must be a number
    // - Required field
    Grade_ID: joi_1.default.number()
        .integer()
        .required()
        .messages({
    ...
    // - Must be a number
    // - Required field
    Student_ID: joi_1.default.number()
        .integer()
        .required()
        .messages({
    ...
    // - Must be a string
    // - Required field
    Subj_desc: joi_1.default.string()
        .required()
        .messages({
    ...
    // - Must be a string
    // - Optional field
    Remarks: joi_1.default.string().optional().messages({
